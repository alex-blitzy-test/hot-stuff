...
package initializer (Source: api/__init__.py:L50) -- and, when the module is
...
``CMD ["python3", "app.py"]`` invokes it (Source: Dockerfile:L15), which launches
...
How to run:
    ...
    Docker:
        ...
        ``CMD`` described above. Source: docker-compose.yml:L3-L11
"""
...
if __name__ == '__main__':
    ...
    # (Source: Dockerfile:L13) and Compose maps host port 80 -> container port 5000
    # (Source: docker-compose.yml:L10-L11). The port is left at Flask's default of
